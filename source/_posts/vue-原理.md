...
> **`Set` 类型** 的原型 **属性** 和 **方法** 如下，[**详情可见**](https://link.juejin.cn?target=https%3A%2F%2Fdeveloper.mozilla.org%2Fzh-CN%2Fdocs%2FWeb%2FJavaScript%2FReference%2FGlobal_Objects%2FSet)：
